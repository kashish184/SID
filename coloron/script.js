class Game {
  ...
  showGrade(score) {
    if (score > 30) return "Chuck Norris?";
      ...
      return "You're da man, you won: 25 MINUTES OF T.V TIME";
    else if (score > 20) return "Awesome you won: 15 MINUTES OF T.V TIME";
    else if (score > 15) return "Great! you won: 10 MINUTES OF T.V TIME";
    else if (score > 13)
      return "Nice! you won: 5 MINUTES OF T.V TIME, PLAY AGAIN TO EARN MORE";
    else if (score > 10)
      return "Good Job!,  you won: 5 MINUTES OF T.V TIME, PLAY AGAIN TO EARN MORE";
    else if (score > 5)
      return "You can do better, you won: 2 MINUTES OF T.V TIME, PLAY AGAIN TO EARN MORE";
    else return "Come on bud!!, PLAY AGAIN TO WIN T.V TIME";
  }
